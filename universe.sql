...
INSERT INTO public.galaxy VALUES ('Disk', 1, 1000, 'boring galaxy', 'extra boring');
...
--
-- Name: the_fifth_table the_fifth_table_the_fifth_table_id_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.the_fifth_table
    ADD CONSTRAINT the_fifth_table_the_fifth_table_id_key UNIQUE (the_fifth_table_id);
